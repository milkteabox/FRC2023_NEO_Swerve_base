...
public final class Constants
{
    ...
    public static final Rotation2d SWERVE_LEFTRARE_OFFSET = Rotation2d.fromDegrees(0.0);
    public static final Rotation2d SWERVE_RIGHTFRONT_OFFSET = Rotation2d.fromDegrees(0.0);
    public static final Rotation2d SWERVE_RIGHTRARE_OFFSET = Rotation2d.fromDegrees(0.0);
    ...
    public static final CANSparkMax.IdleMode DRIVE_NEUTRAL_MODE = CANSparkMax.IdleMode.kBrake;
